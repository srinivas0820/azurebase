 ...
 * package com.jbhunt;
 * 
 * import java.util.*; import com.microsoft.azure.functions.annotation.*; import
 ...
 *//**
	 ...
	 *//*
		 * @FunctionName("HttpTrigger-Java") public HttpResponseMessage run(
		 * 
		 * @HttpTrigger(name = "req", methods = {HttpMethod.GET, HttpMethod.POST},
		 * authLevel = AuthorizationLevel.FUNCTION) HttpRequestMessage<Optional<String>>
		 * request, final ExecutionContext context) {
		 * 
		 * context.getLogger().info("Java HTTP trigger processed a request.");
		 * 
		 * // Parse query parameter String query =
		 * request.getQueryParameters().get("name"); String name =
